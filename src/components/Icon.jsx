 ...
 * Inline SVG keeps the bundle light and means icons never flash in late.
 */
...
const PATHS = {
  ...
  calendarPlus: (
    <>
      <rect x="3" y="4" width="18" height="18" rx="2" />
      <path d="M8 2v4M16 2v4M3 10h18M12 14v5M9.5 16.5h5" />
    </>
  ),
  clock: (
    <>
  ...
  play: <path d="M6 3.5l13 8.5-13 8.5v-17z" />,
...
/** Multi-colour Google mark for the sign-in button. */
export function GoogleMark({ size = 18 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 48 48" aria-hidden="true">
      <path fill="#EA4335" d="M24 9.5c3.5 0 6.6 1.2 9 3.6l6.7-6.7C35.6 2.6 30.2.5 24 .5 14.6.5 6.5 5.9 2.6 13.7l7.8 6c1.9-5.6 7.1-10.2 13.6-10.2z" />
      <path fill="#4285F4" d="M46.5 24.5c0-1.6-.1-3.1-.4-4.5H24v9h12.7c-.6 3-2.3 5.5-4.8 7.2l7.5 5.8c4.4-4.1 7.1-10.1 7.1-17.5z" />
      <path fill="#FBBC05" d="M10.4 28.3a14.5 14.5 0 0 1 0-8.6l-7.8-6a24 24 0 0 0 0 20.6l7.8-6z" />
      <path fill="#34A853" d="M24 47.5c6.5 0 11.9-2.1 15.9-5.8l-7.5-5.8c-2.1 1.4-4.8 2.3-8.4 2.3-6.5 0-11.7-4.6-13.6-10.2l-7.8 6C6.5 42.1 14.6 47.5 24 47.5z" />
    </svg>
  )
}
